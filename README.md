# RelevantCourses
Contains list of all courses that are crucial to Autonomous Vehicles and Robotics in general. This list has been borrowed from Mithi (https://github.com/mithi) and contains some additional courses.
